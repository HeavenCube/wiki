---
label: Protections de terrain
title: Protéger son terrain
description: Découvrez comment réserver une zone et gérer les accès des autres joueurs.
icon: shield-lock
order: 590
---
...
Sujet : menu ou affichage en jeu montrant les limites et permissions d’une protection de terrain
Fichier recommandé : assets/images/menu-protection-terrain.webp
Dimensions recommandées : 1000 × 1000 px
Format recommandé : WebP
Texte alternatif : Menu de gestion d’une protection de terrain sur HeavenCube
-->
<!-- ![Menu des protections de terrain](assets/images/menu-protection-terrain.webp) -->

...
description: Découvrez comment rejoindre un métier et suivre sa progression.
icon: tools
order: 560
---
...
Sujet : menu Minecraft listant les métiers disponibles et la progression du joueur
Fichier recommandé : assets/images/menu-metiers.webp
Dimensions recommandées : 1000 × 1000 px
Format recommandé : WebP
Texte alternatif : Menu des métiers disponibles sur HeavenCube
-->
<!-- ![Menu des métiers](assets/images/menu-metiers.webp) -->
